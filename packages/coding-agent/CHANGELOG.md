...
- A session that cannot save now repeats its warning while the failure lasts, instead of warning once and running on silently ([#12624](https://github.com/can1357/oh-my-pi/pull/12624) by [@ParadaCarleton](https://github.com/ParadaCarleton)).
