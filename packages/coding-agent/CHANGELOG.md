...
- Fixed a power-assertion binding missing from the loaded native addon being logged as a warning, hiding a permanently broken sleep inhibition behind transient-failure noise.
