...
- Fixed the Linux ScreenSaver path caching a closed session-bus connection, which left every later sleep-inhibition attempt failing until the process restarted.
